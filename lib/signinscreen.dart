...
import 'package:hemocheker/reset_password.dart';
import 'package:hemocheker/signup_screen.dart';
import 'package:hemocheker/social_icon.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                Center(
                    child: Image.asset("assets/images/logo-no-background1.png", fit: BoxFit.fill,
                      height: height*0.2,
                      width: height*0.2,
                      )),
                SizedBox(
  ...
  Widget forgetPassword(BuildContext context) {
    return Container(
      ...
      child: TextButton(
        child: const Text(
          "Forgot Password?",
          style: TextStyle(color: Color.fromARGB(255, 121, 54, 208)),
